...
def main():
    ...
    triangles = {"left": [(465, 360), (565, 400), (565, 320)], 
    ...
    # with connect("ws://192.168.1.103:8765") as websocket:
    while running:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                try:
                    pygame.draw.polygon(screen, pressed_color, triangles[arrows[event.key]], width=0)
            ...
            if event.type == pygame.KEYUP:
                try:
                    pygame.draw.polygon(screen, released_color, triangles[arrows[event.key]], width=0)
